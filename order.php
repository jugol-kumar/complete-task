...
<div class="row">
                        ...
                        <table id="user_data" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th>Order Status</th>
                                    <th>Order Date</th>
                                    <?php if(isset($_SESSION['type']) && $_SESSION['type'] == 'master') echo "<th>Created By</th>" ?>
                                    <th></th>
                                    <th></th>
                                    <th></th>
                                </tr>
    ...
    <script>
        $(document).ready(function(){
            ...
            var orderdataTable = $('#user_data').DataTable({
                "processing": true,
                "serverSide": true,
                "order": [],
                "ajax":{
            ...
            function add_product_row(count = '')
            {
                ...
                html += '<input type="text" name="quantity[]" class="form-control" placeholder="e.g qty 5" required />';
                html += '</div>';
